...
document.querySelectorAll('.social-link, .contact-item').forEach(element => {
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.countdown-item, .contact-item, .social-link');
